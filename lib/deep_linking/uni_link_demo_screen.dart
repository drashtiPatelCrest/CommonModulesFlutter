...
class UniLinkDemoScreen extends StatefulWidget {
  const UniLinkDemoScreen({Key? key}) : super(key: key);

  @override
  State<UniLinkDemoScreen> createState() => _UniLinkDemoScreenState();
}

class _UniLinkDemoScreenState extends State<UniLinkDemoScreen> {
  Uri? _initialURI;
  Uri? _currentURI;
  Object? _err;
  ...
  Future<void> _initURIHandler() async {
    if (!_initialURILinkHandled) {
      ...
      debugPrint("Init URI => _initURIHandler");
