...
class SecureApplicationScreen extends StatefulWidget {
  final String title;

  const SecureApplicationScreen({Key? key, required this.title})
      : super(key: key);

  @override
  State<SecureApplicationScreen> createState() =>
      _SecureApplicationScreenState();
}

class _SecureApplicationScreenState extends State<SecureApplicationScreen> {
...
extension on _SecureApplicationScreenState {
  Widget _mainView() {
    var width = MediaQuery.of(context).size.width * 0.8;
